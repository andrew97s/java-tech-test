...
public class Print_ResturnRFIDData_Net {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Print_ResturnRFIDData();
	}
     ...
     String printers="";
	  ...
	  private static void Print_ResturnRFIDData()
      {
    ...
    */
    int mm = 12;
       ...
       if (result != 0) {
          ...
          /* 打印文字*/
          result_printing = PrintLab.PTK_DrawText_TrueType((int)(93 + offset_X), (int)(65 + offset_Y), 53, 0, "Arial", 1, 400, false, false, false, "SAS795389302000000014" );
          if (result_printing != 0) { Printers.showError("PTK_DrawText_TrueType", result_printing); return; }

          /* 打印QR码*/
          result_printing = PrintLab.PTK_DrawBar2D_QR((int)(23 + offset_X), (int)(61 + offset_Y), 0, 0, 0, 3, 4, 1, 8, "SAS795389302000000014");
          ...
          if (result_printing != 0) { Printers.showError("PTK_RFIDEndPrintLabel", result_printing); return; }
          ...
          System.err.println("执行成功并返回RFID数据："+ RFIDData);
      }
