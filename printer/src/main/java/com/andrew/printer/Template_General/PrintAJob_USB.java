     ...
     String printers="";
	  ...
	  private static void PrintAJob()
      {
        ...
        return;
          ...
          for(int i = 0; i < 5; i++) { 
          /*打印本地图片*/
          //result_printing = PrintLab.PTK_AnyGraphicsPrint((int)(413 + offset_X), (int)(135 + offset_Y), "logo", "D;/POSTEK.png", 0.6f, 92, 74, 0);
          /*打印网络图片*/
          ...
          /*打印一维码 此示例为Code128码*/
          result_printing = PrintLab.PTK_DrawBarcode((int)(30 + offset_X), (int)(99 + offset_Y), 0, "1", 2, 6, 40, 'N', "12345678" +i);//打印一维码
          if (result_printing != 0) { Printers.showError("PTK_DrawBarcode", result_printing); return; }

          /* 打印条码下方文字*/
          result_printing = PrintLab.PTK_DrawText_TrueType((int)(30 + offset_X), (int)(99 + 40 + 4 + offset_Y), 2 * mm, 0, "Arial", 1, 400, false, false, false, "12345678" + i);
          ...
          /*打印一维码 此示例为UPC码*/
          result_printing = PrintLab.PTK_DrawBarcode((int)(213 + offset_X), (int)(98 + offset_Y), 0, "UE0", 2, 6, 47, 'B', "234567" + i);
          if (result_printing != 0) { Printers.showError("PTK_DrawBarcode", result_printing); return; }
          ...
          result_printing = PrintLab.PTK_DrawBar2D_QR((int)(30 + offset_X), (int)(182 + offset_Y), 0, 0, 0, 3, 4, 1, 8, "设计精湛 ABCD 1234 ^-^ @@ && $$ ￥￥" + i);
          if (result_printing != 0) { Printers.showError("PTK_DrawBar2D_QR", result_printing); return; }

          /*打印二维码 此示例为datamatrix码*/
          result_printing = PrintLab.PTK_DrawBar2D_DATAMATRIX((int)(272 + offset_X), (int)(182 + offset_Y), 0, 0, 0, 5, "设计精湛 ABCD 1234 ^-^ @@ && $$ ￥￥" + i);
          if (result_printing != 0) { Printers.showError("PTK_DrawBar2D_DATAMATRIX", result_printing); return; }

          /*打印二维码 此示例为PDF417码*/
          result_printing = PrintLab.PTK_DrawBar2D_Pdf417((int)(25 + offset_X), (int)(288 + offset_Y), 240, 38, 3, 0, 2, 2, 10, 6, 0, 0, "设计精湛 ABCD 1234 ^-^ @@ && $$ ￥￥" + i);
          if (result_printing != 0) { Printers.showError("PTK_DrawBar2D_Pdf417", result_printing); return; }

          /*打印二维码 此示例为汉信码*/
          result_printing = PrintLab.PTK_DrawBar2D_HANXIN((int)(155 + offset_X), (int)(182 + offset_Y), 0, 0, 0, 3, 3, 0, 0, "设计精湛 ABCD 1234 ^-^ @@ && $$ ￥￥" + i);
