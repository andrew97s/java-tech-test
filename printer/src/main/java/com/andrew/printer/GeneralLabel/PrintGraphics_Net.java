...
public class PrintGraphics_Net {
	...
	private static void PrintGraphics() {
		...
		/*
		 * mm:点，毫米转为点，由打印机分辨率决定 打印机分辨DPI=203时， mm=8 打印机分辨DPI=300时， mm=12 打印机分辨DPI=600时，
		 * mm=24
		 */
		int mm = 12;
		...
		/* 打印图片 */
		/* /打印网络图片 */
		result_printing = PrintLab.PTK_AnyGraphicsPrint((int) (200 + offset_X), (int) (20 + offset_Y), "picture",
				"https://www.postek.com.cn/print/logo.png", 1, 0, 0, 0);
		/* 打印本地图片 */
		// result_printing = PrintLab.PTK_AnyGraphicsPrint((int)(20 + offset_X),
		// (int)(20 + offset_Y),"picture","D:/logo.jpg",1,0,0,0);
		if (result_printing != 0) {
			Printers.showError("PTK_AnyGraphicsPrint", result_printing);
			return;
		}
