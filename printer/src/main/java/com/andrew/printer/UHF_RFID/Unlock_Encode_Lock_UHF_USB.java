...
public class Unlock_Encode_Lock_UHF_USB {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Unlock_Encode_Lock_UHF();
	}

	static CDFPSKDll PrintLab = CDFPSKDll.Instance;

	private static void Unlock_Encode_Lock_UHF() {
        /*
      ...
      return;
        ...
        if (result_printing != 0) { Printers.showError("PTK_SetRFLabelPWAndLockRFLabel", result_printing); return; }
