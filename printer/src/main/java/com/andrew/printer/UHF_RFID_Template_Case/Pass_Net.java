    ...
    */
    int mm = 12;
       ...
       if (result != 0) {
          ...
          /*打印二维码*/
          result_printing = PrintLab.PTK_DrawBar2D_QR((int)(offset_X + 216), (int)(offset_Y + 401), 0, 0, 0, 5, 4, 1, 8, "IOTE 2021第十六届国际物联网展   ·  深圳站8月18-20日 深圳会展中心（福田）参展人：高大参展单位：深圳市博思得科技发展有限公司");
          if (result_printing != 0) { Printers.showError("PTK_DrawBar2D_QR", result_printing); return; }

          /*打印文字*/
          result_printing = PrintLab.PTK_DrawText_TrueType((int)(offset_X + 258), (int)(offset_Y + 309), 67, 0, "Arial", 1, 400, false, false, false, "参会证");
          if (result_printing != 0) { Printers.showError("PTK_DrawText_TrueType", result_printing); return; }

          /*打印文字*/
          result_printing = PrintLab.PTK_DrawText_TrueType((int)(offset_X + 90), (int)(offset_Y + 188), 50, 0, "Arial", 1, 400, false, false, false, "国际物联网展   ·  深圳站");
          if (result_printing != 0) { Printers.showError("PTK_DrawText_TrueType", result_printing); return; }

          /*打印文字*/
          result_printing = PrintLab.PTK_DrawText_TrueType((int)(offset_X + 85), (int)(offset_Y + 78), 83, 0, "Arial", 1, 400, false, false, false, "IOTE 2021");
          if (result_printing != 0) { Printers.showError("PTK_DrawText_TrueType", result_printing); return; }

          /*打印文字*/
          result_printing = PrintLab.PTK_DrawText_TrueType((int)(offset_X + 486), (int)(offset_Y + 112), 38, 0, "Arial", 1, 400, false, false, false, "第十六届");
          if (result_printing != 0) { Printers.showError("PTK_DrawText_TrueType", result_printing); return; }

          /*打印文字*/
          result_printing = PrintLab.PTK_DrawText_TrueType((int)(offset_X + 54), (int)(offset_Y + 838), 46, 0, "Arial", 1, 400, false, false, false, "8月18-20日 深圳会展中心（福田）");
          if (result_printing != 0) { Printers.showError("PTK_DrawText_TrueType", result_printing); return; }

          /*打印文字*/
          result_printing = PrintLab.PTK_DrawText_TrueType((int)(offset_X + 54), (int)(offset_Y + 711), 33, 0, "Arial", 1, 400, false, false, false, "参展人：高大");
          if (result_printing != 0) { Printers.showError("PTK_DrawText_TrueType", result_printing); return; }

          /*打印文字*/
          result_printing = PrintLab.PTK_DrawText_TrueType((int)(offset_X + 54), (int)(offset_Y + 769), 33, 0, "Arial", 1, 400, false, false, false, "参展单位：深圳市博思得科技发展有限公司");
          if (result_printing != 0) { Printers.showError("PTK_DrawText_TrueType", result_printing); return; }
