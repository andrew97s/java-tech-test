...
public class EndcodeHFRFID_ReturnRFIDData_Net {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		EndcodeHFRFID_ReturnRFIDData();
	}
     ...
     String printers="";
	  ...
	  private static void EndcodeHFRFID_ReturnRFIDData()
      {
          /*设置打印机IP地址*/
    ...
    */
    int mm = 12;
       ...
       if (result != 0) {
          ...
          if (result_printing != 0) { Printers.showError("PTK_ReadHFRFIDSetting", result_printing); return; }
